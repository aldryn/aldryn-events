...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.start_at'
        db.delete_column(u'aldryn_events_event', 'start_at')

        # Deleting field 'Event.end_at'
        db.delete_column(u'aldryn_events_event', 'end_at')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Event.start_at'
        raise RuntimeError("Cannot reverse this migration. 'Event.start_at' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Event.start_at'
        db.add_column(u'aldryn_events_event', 'start_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Event.end_at'
        raise RuntimeError("Cannot reverse this migration. 'Event.end_at' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Event.end_at'
        db.add_column(u'aldryn_events_event', 'end_at',
