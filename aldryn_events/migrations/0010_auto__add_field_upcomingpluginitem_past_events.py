...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UpcomingPluginItem.past_events'
        db.add_column(u'aldryn_events_upcomingpluginitem', 'past_events',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UpcomingPluginItem.past_events'
        db.delete_column(u'aldryn_events_upcomingpluginitem', 'past_events')
