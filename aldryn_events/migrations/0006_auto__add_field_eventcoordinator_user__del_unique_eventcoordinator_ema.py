...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'EventCoordinator', fields ['email']
        db.delete_unique(u'aldryn_events_eventcoordinator', ['email'])

        # Adding field 'EventCoordinator.user'
        db.add_column(u'aldryn_events_eventcoordinator', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventCoordinator.user'
        db.delete_column(u'aldryn_events_eventcoordinator', 'user_id')

        # Adding unique constraint on 'EventCoordinator', fields ['email']
        db.create_unique(u'aldryn_events_eventcoordinator', ['email'])
