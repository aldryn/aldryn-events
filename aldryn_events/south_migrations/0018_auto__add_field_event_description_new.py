...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.description_new'
        db.add_column(u'aldryn_events_event', 'description_new',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.description_new'
        db.delete_column(u'aldryn_events_event', 'description_new_id')
