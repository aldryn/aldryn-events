...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventTranslation.location_lat'
        db.add_column(u'aldryn_events_event_translation', 'location_lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventTranslation.location_lng'
        db.add_column(u'aldryn_events_event_translation', 'location_lng',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventTranslation.location_lat'
        db.delete_column(u'aldryn_events_event_translation', 'location_lat')

        # Deleting field 'EventTranslation.location_lng'
        db.delete_column(u'aldryn_events_event_translation', 'location_lng')
