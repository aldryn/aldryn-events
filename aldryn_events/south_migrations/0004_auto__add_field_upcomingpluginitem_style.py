...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UpcomingPluginItem.style'
        db.add_column(u'aldryn_events_upcomingpluginitem', 'style',
                      self.gf('django.db.models.fields.CharField')(default='standard', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UpcomingPluginItem.style'
        db.delete_column(u'aldryn_events_upcomingpluginitem', 'style')
