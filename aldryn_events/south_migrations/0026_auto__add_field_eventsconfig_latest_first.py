...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventsConfig.latest_first'
        db.add_column(u'aldryn_events_eventsconfig', 'latest_first',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventsConfig.latest_first'
        db.delete_column(u'aldryn_events_eventsconfig', 'latest_first')
