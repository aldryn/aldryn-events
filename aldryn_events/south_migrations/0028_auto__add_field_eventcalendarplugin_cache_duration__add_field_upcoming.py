...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventCalendarPlugin.cache_duration'
        db.add_column(u'aldryn_events_eventcalendarplugin', 'cache_duration',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UpcomingPluginItem.cache_duration'
        db.add_column(u'aldryn_events_upcomingpluginitem', 'cache_duration',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventCalendarPlugin.cache_duration'
        db.delete_column(u'aldryn_events_eventcalendarplugin', 'cache_duration')

        # Deleting field 'UpcomingPluginItem.cache_duration'
        db.delete_column(u'aldryn_events_upcomingpluginitem', 'cache_duration')
    ...
    models = {
        ...
        u'aldryn_events.eventsconfigtranslation': {
            ...
            'app_title': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '234'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
