...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventTranslation.flyer'
        db.delete_column(u'aldryn_events_event_translation', 'flyer_id')


    def backwards(self, orm):
        # Adding field 'EventTranslation.flyer'
        db.add_column(u'aldryn_events_event_translation', 'flyer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_flyers', null=True, to=orm['filer.File'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
