...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Registration.address_zip'
        db.alter_column(u'aldryn_events_registration', 'address_zip', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Registration.address_zip'
        db.alter_column(u'aldryn_events_registration', 'address_zip', self.gf('django.db.models.fields.CharField')(max_length=4))
