...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventCalendarPlugin.app_config'
        db.alter_column(u'aldryn_events_eventcalendarplugin', 'app_config_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['aldryn_events.EventsConfig']))

        # Changing field 'Event.app_config'
        db.alter_column(u'aldryn_events_event', 'app_config_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['aldryn_events.EventsConfig']))

        # Changing field 'UpcomingPluginItem.app_config'
        db.alter_column(u'aldryn_events_upcomingpluginitem', 'app_config_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['aldryn_events.EventsConfig']))

        # Changing field 'EventListPlugin.app_config'
        db.alter_column(u'aldryn_events_eventlistplugin', 'app_config_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['aldryn_events.EventsConfig']))

    def backwards(self, orm):

        # Changing field 'EventCalendarPlugin.app_config'
        db.alter_column(u'aldryn_events_eventcalendarplugin', 'app_config_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_events.EventsConfig'], null=True))

        # Changing field 'Event.app_config'
        db.alter_column(u'aldryn_events_event', 'app_config_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_events.EventsConfig'], null=True))

        # Changing field 'UpcomingPluginItem.app_config'
        db.alter_column(u'aldryn_events_upcomingpluginitem', 'app_config_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_events.EventsConfig'], null=True))

        # Changing field 'EventListPlugin.app_config'
        db.alter_column(u'aldryn_events_eventlistplugin', 'app_config_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_events.EventsConfig'], null=True))
