...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aldryn_events_eventlistplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('style', self.gf('django.db.models.fields.CharField')(default='standard', max_length=50)),
        ))
        db.send_create_signal(u'aldryn_events', ['EventListPlugin'])


        # Adding SortedM2M table for field events on 'EventListPlugin'
        db.create_table(u'aldryn_events_eventlistplugin_events', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventlistplugin', models.ForeignKey(orm[u'aldryn_events.eventlistplugin'], null=False)),
            ('event', models.ForeignKey(orm[u'aldryn_events.event'], null=False)),
            ('sort_value', models.IntegerField())
        ))
        db.create_unique(u'aldryn_events_eventlistplugin_events', ['eventlistplugin_id', 'event_id'])

    def backwards(self, orm):
        # Deleting model 'EventListPlugin'
        db.delete_table(u'aldryn_events_eventlistplugin')

        # Removing M2M table for field events on 'EventListPlugin'
        db.delete_table(db.shorten_name(u'aldryn_events_eventlistplugin_events'))
