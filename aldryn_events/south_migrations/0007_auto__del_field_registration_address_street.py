...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Registration.address_street'
        db.delete_column(u'aldryn_events_registration', 'address_street')


    def backwards(self, orm):
        # Adding field 'Registration.address_street'
        db.add_column(u'aldryn_events_registration', 'address_street',
