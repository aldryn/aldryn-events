...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('aldryn_events_event', 'description_new_id', 'description_id')

        # Deleting field 'EventTranslation.description'
        db.delete_column(u'aldryn_events_event_translation', 'description_id')
