...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventCalendarPlugin'
        db.create_table(u'aldryn_events_eventcalendarplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('app_config', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_events.EventsConfig'], null=True)),
        ))
        db.send_create_signal(u'aldryn_events', ['EventCalendarPlugin'])

        # Adding model 'EventsConfig'
        db.create_table(u'aldryn_events_eventsconfig', (
        ...
        db.send_create_signal(u'aldryn_events', ['EventsConfig'])

        # Adding model 'EventsConfigTranslation'
        db.create_table(u'aldryn_events_eventsconfig_translation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('app_title', self.gf('django.db.models.fields.CharField')(max_length=234)),
            (u'master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['aldryn_events.EventsConfig'])),
        ))
        db.send_create_signal(u'aldryn_events', ['EventsConfigTranslation'])

        # Adding unique constraint on 'EventsConfigTranslation', fields ['language_code', u'master']
        db.create_unique(u'aldryn_events_eventsconfig_translation', ['language_code', u'master_id'])

        # Adding field 'UpcomingPluginItem.app_config'
        db.add_column(u'aldryn_events_upcomingpluginitem', 'app_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_events.EventsConfig'], null=True),
                      keep_default=False)

        # Adding field 'EventListPlugin.app_config'
        db.add_column(u'aldryn_events_eventlistplugin', 'app_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_events.EventsConfig'], null=True),
                      keep_default=False)

        # Adding field 'Event.app_config'
        db.add_column(u'aldryn_events_event', 'app_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_events.EventsConfig'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'EventsConfigTranslation', fields ['language_code', u'master']
        db.delete_unique(u'aldryn_events_eventsconfig_translation', ['language_code', u'master_id'])

        # Deleting model 'EventCalendarPlugin'
        db.delete_table(u'aldryn_events_eventcalendarplugin')

        # Deleting model 'EventsConfig'
        db.delete_table(u'aldryn_events_eventsconfig')

        # Deleting model 'EventsConfigTranslation'
        db.delete_table(u'aldryn_events_eventsconfig_translation')

        # Deleting field 'UpcomingPluginItem.app_config'
        db.delete_column(u'aldryn_events_upcomingpluginitem', 'app_config_id')

        # Deleting field 'EventListPlugin.app_config'
        db.delete_column(u'aldryn_events_eventlistplugin', 'app_config_id')

        # Deleting field 'Event.app_config'
        db.delete_column(u'aldryn_events_event', 'app_config_id')
