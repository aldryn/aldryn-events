...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'aldryn_events', ['UpcomingPluginItem'])
    ...
    models = {
        ...
        u'aldryn_events.UpcomingPluginItem': {
            'Meta': {'object_name': 'UpcomingPluginItem', 'db_table': "u'cmsplugin_UpcomingPluginItem'", '_ormbases': ['cms.CMSPlugin']},
