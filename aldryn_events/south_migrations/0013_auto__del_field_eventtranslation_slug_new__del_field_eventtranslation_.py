...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming fields on translatable model
        db.rename_column(
            'aldryn_events_event_translation', 'slug_new', 'slug'
        )
        db.rename_column(
            'aldryn_events_event_translation', 'flyer_new_id', 'flyer_id'
        )
        db.rename_column(
            'aldryn_events_event_translation', 'image_new_id', 'image_id'
        )
        db.rename_column(
            'aldryn_events_event_translation', 'description_new_id', 'description_id'
        )

        # Deleting fields on Event model
        db.delete_column(u'aldryn_events_event', 'description_id')
        db.delete_column(u'aldryn_events_event', 'image_id')
        db.delete_column(u'aldryn_events_event', 'slug')
        db.delete_column(u'aldryn_events_event', 'flyer_id')

        # Adding unique constraint on 'EventTranslation'
        db.create_unique(u'aldryn_events_event_translation', ['language_code', 'slug'])

    def backwards(self, orm):
        # Removing unique constraint on 'EventTranslation'
        db.delete_unique(u'aldryn_events_event_translation', ['language_code', 'slug'])

        # Renaming fields on translatable model
        db.rename_column(
            'aldryn_events_event_translation', 'slug', 'slug_new'
        )
        db.rename_column(
            'aldryn_events_event_translation', 'flyer_id', 'flyer_new_id'
        )
        db.rename_column(
            'aldryn_events_event_translation', 'image_id', 'image_new_id'
        )
        db.rename_column(
            'aldryn_events_event_translation', 'description_id', 'description_new_id'
        )

        # Adding old fields back in Event model
        db.add_column(u'aldryn_events_event', 'description',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True),
                      keep_default=False)
        db.add_column(u'aldryn_events_event', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['filer.Image'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
        db.add_column(u'aldryn_events_event', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=150, null=True, blank=True),
                      keep_default=False)
        db.add_column(u'aldryn_events_event', 'flyer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['filer.File'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
